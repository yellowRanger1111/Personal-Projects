...
def load_policy(filename, state_size=231, hidden_layer_size=256):
...
def evaluate(seed=37429879, timed=False, filename="./rl-weights.pth", debug=False, refresh=1):
    ...
    env, max_steps, _, _, observation_tree_depth, _ = create_default_single_agent_environment(seed, timed)
...
def main():
    ...
    seed = 37429879
    timed = True
    filename = "./changed-rl-timed-weights.pth"
    _debug = False
    _refresh = 0.05
